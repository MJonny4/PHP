<div class="w3-top w3-top w3-black">
  <a href="#" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-black">Home</a>
  <a href="#about" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-black">About</a>
  <a href="#features" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-black">Features</a>
